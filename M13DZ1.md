...
graph LR
    ...
    classDef systemBoundary fill:#fff,stroke:#333,stroke-width:1px,stroke-dasharray: 5 5;
    ...
    %% НАСЛЕДОВАНИЕ РОЛЕЙ
    %% Библиотекарь и Админ наследуют функционал Читателя
